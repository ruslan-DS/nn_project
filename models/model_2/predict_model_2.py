import torch
from models.model_2.model_2 import model_2, DEVICE
from models.model_2.preprocessing_2 import make_preproc


def predict_2(image):

    dict_classes = {0: 'Black footed Albatross',
                     1: 'Laysan Albatross',
                     2: 'Sooty Albatross',
                     3: 'Groove billed Ani',
                     4: 'Crested Auklet',
    ...
    model_2.eval()
    predict = torch.argmax(model_2(image.unsqueeze(0).to(DEVICE)), dim=1).item()
